...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    {
        public event Action<ThrowableThrowData> OnThrowEvent;
        public event Action OnReequipThrowableItemEvent;
        ...
        {
            OnReequipThrowableItemEvent?.Invoke();
        }
    }
}