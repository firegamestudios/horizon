        ...
        protected virtual void Start()
        {
            ...
            if (m_FreeRoam) {
                ...
                if (spawnCharacter) {
                    ...
                    var spawnRotation = m_FreeRoamSpawnLocation.eulerAngles;
                    spawnRotation.x = spawnRotation.z = 0;
                    characterLocomotion.SetPositionAndRotation(m_FreeRoamSpawnLocation.position, Quaternion.Euler(spawnRotation));
                }
